"""
Улучшенный аналитический менеджер для ЕВА
...
logger = logging.getLogger("eva.analytics_manager")

class AnalyticsManager:
    """Основной менеджер аналитики для ЕВА"""
    ...
    def _init_components(self):
        ...
        try:
            ...
            # KnowledgeAnalytics
            from eva.knowledge.knowledge_analytics import KnowledgeAnalytics
