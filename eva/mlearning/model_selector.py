...
class ModelSelector:
    ...
    def __init__(self, cache_dir: Optional[str] = None):
        self.cache_dir = cache_dir or os.path.join(os.getcwd(), "eva_cache", "models")
    ...
    def _load_bitnet(self, model_name: str) -> bool:
        ...
        try:
            from eva.mlearning.bitnet_model_manager import BitNetModelManager
