...
logger = logging.getLogger("eva.training.orchestrator")
...
class TrainingOrchestrator:
    """
    Coordinates sequential knowledge graph training across the ЕВА stack.
    ...
    def __init__(
        ...
        self.brain = brain
        self.cache_dir = cache_dir or os.path.join(os.getcwd(), "eva_cache", "training")
        ...
        try:
            ...
            if brain is None:
                try:
                    ...
                    import eva.core.core_brain as core_module
