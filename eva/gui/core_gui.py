...
class ЕВАGUI:
    ...
    def __init__(self, brain=None, integrator=None, cache_dir: Optional[str] = None):
        ...
        self.chat_logger = logging.getLogger("eva.gui.chat")
    ...
    def _init_modules(self):
        ...
        if not chat_initialized:
            try:
                ...
                module_path = 'eva.gui.chat_module'
        ...
        module_map = {
            "memory": ("eva.gui.memory_module", "MemoryModule"),
        }
    ...
    def start(self):
        ...
        try:
            ...
            #     self.root = tk.Tk()
            #     self.root.title("ЕВА - Адаптивная когнитивная система")
