...
try:
    from eva.distributed.database_utils import get_connection, execute_query
except ImportError:
    get_connection = None
    execute_query = None

try:
    from eva.knowledge.context_entity import EntityExtractor, AmbiguousEntity, AmbiguityType
except ImportError:
...
logger = logging.getLogger("eva.contradiction.core")
