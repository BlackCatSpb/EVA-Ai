...
logger = logging.getLogger("eva.response_generator")
...
try:
    from eva.core.event_system import EventBus, ComponentInitializationManager
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    pass
                model_rel_path = cfg.get('model', {}).get('path', 'eva/mlearning/eva_models/qwen3.5-0.8b')
