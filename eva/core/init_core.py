...
logger = logging.getLogger("eva.component_initializer.core")
...
class ComponentInitializer:
    ...
    def __init__(self, core_brain):
        ...
        from eva.core.init_connections import define_dependencies
        self.component_dependencies = define_dependencies()

        from eva.core.init_factories import register_all_factories
    ...
    def initialize_components(self, component_list: Optional[List[str]] = None) -> bool:
        ...
        try:
            ...
            for component_name in components_to_init:
                ...
                from eva.core.init_connections import validate_dependencies
    ...
    def post_initialize_connections(self):
        ...
        from eva.core.init_connections import post_initialize_connections as _setup
        _setup(self)
    ...
    def get_initialization_status(self) -> Dict[str, Any]:
        ...
        from eva.core.init_validation import get_initialization_status
    ...
    def retry_failed_components(self) -> Dict[str, bool]:
        ...
        from eva.core.init_validation import retry_failed_components
    ...
    def get_component_health(self, component_name: str) -> Dict[str, Any]:
        ...
        from eva.core.init_validation import get_component_health
    ...
    def get_all_component_health(self) -> Dict[str, Dict[str, Any]]:
        ...
        from eva.core.init_validation import get_all_component_health
