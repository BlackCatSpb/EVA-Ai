"""
Интеграционный слой ЕВА - центральный контроллер для обработки запросов.
...
class ЕВАIntegrator:
    ...
    def _setup_event_subscriptions(self):
        ...
        try:
            ...
            # === Two-Model Pipeline подписки ===
            # Подписка на начало pipeline
            self.event_bus.subscribe(
                'pipeline.start',
            ...
            # Подписка на завершение Model A
            self.event_bus.subscribe(
            ...
            # Подписка на завершение веб-поиска
            self.event_bus.subscribe(
            ...
            # Подписка на проверку противоречий
            self.event_bus.subscribe(
            ...
            # Подписка на завершение Model B
            self.event_bus.subscribe(
            ...
            # Подписка на проверку релевантности
            self.event_bus.subscribe(
            ...
            # Подписка на рекурсивное уточнение
            self.event_bus.subscribe(
            ...
            # Подписка на завершение pipeline
            self.event_bus.subscribe(
                'pipeline.complete',
