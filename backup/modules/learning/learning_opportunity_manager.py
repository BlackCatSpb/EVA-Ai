"""Модуль управления возможностями для обучения в ЕВА"""
import json
import os
import sqlite3
import logging
...
from eva.learning.analyzer_core import AnalyzerCore
from eva.learning.learning_opportunity import LearningOpportunity

logger = logging.getLogger("eva.learning_opportunity_manager")

class LearningOpportunityManager:
    """Менеджер возможностей для обучения в ЕВА."""
