"""Модуль оценки этических рисков для ЕВА"""
import os
import logging
import json
import re
...
from eva.ethics.ethics_framework import EthicalAssessment, EthicalPrinciple
...
logger = logging.getLogger("eva.ethics.risk")
