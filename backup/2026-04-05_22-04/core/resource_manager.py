...
class ResourceManager:
    """Управляет системными ресурсами ЕВА."""
    ...
    def _update_metrics(self):
        ...
        if psutil is None:
            logger.warning("psutil not available, cannot update metrics")
            return
        try:
    ...
    def get_system_info(self) -> Dict[str, Any]:
        ...
        """
        if psutil is None:
            logger.warning("psutil not available, cannot get system info")
