...
class KnowledgeGraphOperationsMixin:
    ...
    def _search_nodes_internal(self, query: str, limit: int = 10, 
        ...
        from eva.knowledge.knowledge_graph_types import KnowledgeNode, safe_json_loads
    ...
    def _import_from_json(self, data: Dict[str, Any]) -> bool:
        ...
        from eva.knowledge.knowledge_graph_types import KnowledgeNode, KnowledgeEdge
