...
from eva.gui.chat_messages import ChatMessagesMixin
from eva.gui.chat_input import ChatInputMixin
from eva.gui.chat_history import ChatHistoryMixin
from eva.gui.chat_actions import ChatActionsMixin
from eva.gui.chat_reasoning import ChatReasoningMixin
from eva.gui.chat_text_utils import _to_display_str, _fix_mojibake
...
class ChatModule(ChatMessagesMixin, ChatInputMixin, ChatHistoryMixin, ChatActionsMixin, ChatReasoningMixin):
    ...
    def _display_text_file(self, filepath: str):
        ...
        try:
            from eva.tools.document_reader import DocumentTextReader
    ...
    def _invoke_knowledge_integration(self, concept: str):
        ...
        try:
            from eva.knowledge.knowledge_integrator import KnowledgeIntegrator
        except Exception as e:
