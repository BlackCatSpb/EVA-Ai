...
Заимствовано из FCP/src/fcp_gnn/graph_encoder.py
Для обучения в Colab с PyTorch/torch-geometric.
"""
import torch
...
class GraphEncoderRuntime:
    """
    Runtime обёртка для GraphEncoder (numpy-only, без torch-geometric).
    """
