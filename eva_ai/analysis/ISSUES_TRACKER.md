...
| # | Проблема | Приоритет | Статус | Комментарий |
|---|----------|----------|--------|-------------|
| 3.2.1 | 2 версии ContradictionAnalyzer | [ВЫС] | [ ] | analytics vs contradiction |
...
| # | Проблема | Приоритет | Статус | Комментарий |
|---|----------|----------|--------|-------------|
| 4.1.1 | **НЕТ EventBus интеграции** | [КРИТ] | [ ] | Не подписан, не публикует |
...
| # | Проблема | Приоритет | Статус | Комментарий |
|---|----------|----------|--------|-------------|
| 5.1.1 | brain_query вызывает напрямую (без MAM) | [КРИТ] | [ ] | Нет координации доступа |
| 5.1.2 | ТРОЙНАЯ абстракция | [ВЫС] | [ ] | PipelineAdapter → GC → Provider |
| 5.1.3 | max_tokens завышены x16-32 | [СРЕД] | [ ] | LOGIC=4096, CONTEXT=4096 |
