...
class TextProcessor:
    ...
    def __init__(self, 
        ...
        if model_name == "qwen2.5-0.5b":
            ...
            self.tokenizer_path = os.path.join(project_root, "eva_ai", "mlearning", "eva_models", "qwen3.5-2b")
        elif os.path.isdir(model_name):
            self.tokenizer_path = model_name
        else:
            self.tokenizer_path = os.path.join(project_root, "eva_ai", "mlearning", "eva_models", model_name) if not os.path.isabs(model_name) else model_name
