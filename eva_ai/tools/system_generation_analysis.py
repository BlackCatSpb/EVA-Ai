"""
Комплексный анализ системы генерации текста ЕВА
...
class SystemAnalyzer:
    ...
    def analyze_generation_flow(self) -> Dict[str, Any]:
        ...
        manager_analysis = self.analyze_module_structure(
            'eva_ai.mlearning.optimized_fractal_model_manager',
        ...
        dependencies = [
            'eva_ai.mlearning.text_quality_trainer',
            'eva_ai.mlearning.text_quality_improver', 
            'eva_ai.websearch',
            'eva_ai.mlearning.web_search_learning_integration',
            'eva_ai.memory.hybrid_token_cache',
            'transformers'
        ]
    ...
    def analyze_file_structure(self) -> Dict[str, Any]:
        ...
        key_files = {
            'optimized_fractal_model_manager': 'eva/mlearning/optimized_fractal_model_manager.py',
            'text_quality_trainer': 'eva/mlearning/text_quality_trainer.py',
            'text_quality_improver': 'eva/mlearning/text_quality_improver.py',
            'hybrid_token_cache': 'eva/memory/hybrid_token_cache.py',
            'fractal_store': 'eva/mlearning/storage/fractal_store.py',
            'fractal_model_loader': 'eva/mlearning/storage/fractal_model_loader.py'
        }
