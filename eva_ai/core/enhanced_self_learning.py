"""
Расширенная система самообучения ЕВА с эпохами и интеграцией графа памяти
"""
...
logger = logging.getLogger("eva_ai.enhanced_self_learning")
    ...
    def _collect_system_data(self) -> List[str]:
        ...
        try:
            ...
            if len(collected_texts) < 10:
                base_texts = [
                    "Система ЕВА использует фрактальные нейронные сети для обработки текста.",
