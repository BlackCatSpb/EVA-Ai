"""Модуль веб-поиска для ЕВА - обеспечивает поиск информации в интернете"""
import os
import json
import sqlite3
import logging
...
logger = logging.getLogger("eva_ai.web_search")
...
class WebSearchEngine:
    ...
    def __init__(self, brain=None, cache_dir: Optional[str] = None):
        ...
        """
        self.brain = brain
        self.cache_dir = cache_dir or os.path.join(os.path.dirname(__file__), "eva_web_search_cache")
