...
logger = logging.getLogger("eva_ai.knowledge.qwen_api_enhancer")
...
class QwenAPIEnhancer:
    ...
    def _initialize_components(self):
        ...
        if self.api_key:
            try:
                from eva_ai.mlearning.qwen_api_client import QwenAPIClient
    ...
    def _enhance_with_qwen(
        ...
        prompt = f"""Ты - экспертный ассистент ЕВА.
