...
Графический интерфейс ЕВА - интеграция с единой фрактальной архитектурой
"""

import logging

logger = logging.getLogger("eva_ai.gui")

# Импорт основных компонентов GUI
def create_gui(brain=None, **kwargs):
    """Фабричная функция для создания экземпляра ЕВАGUI."""
    logger.info("Создание экземпляра ЕВАGUI через фабричную функцию.")
