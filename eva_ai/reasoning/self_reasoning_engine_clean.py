...
class SelfReasoningEngine:
    ...
    def process_query(self, query: str, user_context: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        logger.info(f"Проверка Two-Model Pipeline: brain={self.brain is not None}, two_model_pipeline={hasattr(self.brain, 'two_model_pipeline') and self.brain.two_model_pipeline is not None}")
        ...
        if hasattr(self.brain, 'two_model_pipeline') and self.brain.two_model_pipeline:
            ...
            try:
                ...
                pipeline_result = self.brain.two_model_pipeline.process_query(
                    query=query,
