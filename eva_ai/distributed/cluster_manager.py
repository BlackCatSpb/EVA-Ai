"""Модуль управления кластером для ЕВА - обнаружение и управление узлами"""
import os
import logging
import time
import threading
...
logger = logging.getLogger("eva_ai.distributed.cluster")

class ClusterNode:
    """Представляет узел в кластере ЕВА."""
