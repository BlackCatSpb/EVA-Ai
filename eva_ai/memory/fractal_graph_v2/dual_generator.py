...
DUAL_CIRCUIT_PROMPT_A = """Ты - исследователь. Размышляй вслух над вопросом. Покажи процесс своего мышления, рассуждения и выводы.

Рассуждения:"""

DUAL_CIRCUIT_PROMPT_B = """На основе рассуждений и контекста, дай краткий точный ответ. Используй только валидированные факты.
