...
class ComponentInitializationManager:
    ...
    def __init__(self, event_bus: EventBus):
        ...
        self._logger = logging.getLogger("cogniflex.component_init")
...
class EventSystem:
    ...
    Предоставляет унифицированный интерфейс для работы с событиями в CogniFlex.
    """
    ...
    def __init__(self, timeline_maxlen: int = 1000, enable_timeline: bool = True):
        ...
        self._logger = logging.getLogger("cogniflex.event_system")
