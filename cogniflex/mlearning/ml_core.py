"""Основной модуль машинного обучения для CogniFlex - ядро системы"""
import os
import logging
import time
import threading
...
logger = logging.getLogger("cogniflex.ml_core")
...
class MLCore:
    """Основной интерфейс модуля машинного обучения для CogniFlex."""
    ...
    def __init__(self, brain=None, cache_dir: Optional[str] = None, hybrid_cache=None, token_streamer=None):
        ...
        self.cache_dir = cache_dir or os.path.join(os.path.dirname(__file__), "cogniflex_ml_cache")
