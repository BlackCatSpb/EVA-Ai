"""
GUI Bridge - интеграция Web GUI с CogniFlex Core
"""
import logging
import threading
from typing import Optional, Callable, Any, Dict

logger = logging.getLogger("cogniflex.webgui.bridge")


class GUIBridge:
    """
    Мост между CogniFlex Core и Web GUI.
...
class NetworkBridge:
    """
    Адаптер для сетевого доступа к CogniFlex.
