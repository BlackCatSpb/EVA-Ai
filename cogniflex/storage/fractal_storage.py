...
logger = logging.getLogger("cogniflex.storage.fractal")
...
class FractalStorage:
    ...
    def get_tokenizer(self, model_name: str, **kwargs):
        ...
        try:
            ...
            tokenizer = CogniFlexTokenizer.from_pretrained(
                tokenizer_path,
                **kwargs
            )
    ...
    def get_model(self, task_type: str, **kwargs):
        ...
        """
        from cogniflex.mlearning.cogniflex_tokenizer import CogniFlexTokenizer
        from cogniflex.core.coordinator import Coordinator
        ...
        try:
            ...
            if tokenizer is None:
                ...
                tokenizer = CogniFlexTokenizer(**kwargs.get('tokenizer_kwargs', {}))
