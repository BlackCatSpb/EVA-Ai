"""Ядро системы знаний CogniFlex с поддержкой анализа противоречий"""
import os
import logging
import time
import sqlite3
...
class KnowledgeGraph:
    ...
    def __init__(self, storage_path: Optional[str] = None, brain=None, cache_dir: Optional[str] = None):
        ...
        self.storage_path = storage_path or os.path.join(cache_dir or os.getcwd(), "cogniflex_knowledge.db")
