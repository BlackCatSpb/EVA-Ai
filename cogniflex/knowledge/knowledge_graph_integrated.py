"""
Интегрированный граф знаний для CogniFlex с событийной поддержкой
...
class IntegratedKnowledgeGraph(BaseComponent):
    ...
    интеграцией в событийную систему CogniFlex.
    """
    ...
    def __init__(self, brain=None, cache_dir: Optional[str] = None, 
        ...
        self.cache_dir = cache_dir or os.path.join(
            os.path.dirname(__file__), "cogniflex_knowledge_cache"
        )
