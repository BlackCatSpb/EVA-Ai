"""
Document Text Reader Module for CogniFlex
...
logger = logging.getLogger("cogniflex.document_reader")
...
class DocumentTextReader:
    ...
    def read_as_messages(self, filepath: str, max_lines: int = 100) -> List[Dict[str, str]]:
        ...
        if not doc:
            return [{"sender": "CogniFlex", "text": "Не удалось прочитать файл", "type": "error"}]
