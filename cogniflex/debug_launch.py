#!/usr/bin/env python3
"""
Скрипт для детального логирования запуска системы CogniFlex
"""
import os
import sys
import logging
...
def setup_debug_logging():
    ...
    log_file = f"cogniflex_debug_{timestamp}.log"
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("НАЧАЛО ДЕТАЛЬНОГО ЗАПУСКА COGNIFLEX")
