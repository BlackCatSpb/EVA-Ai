    ...
    try:
        ...
        for i, context in enumerate(contexts):
            ...
            if result and 'keywords' in result:
                ...
                depth_score = analyzer.analyze_context_depth(tokens, context['text'])
                width_score = analyzer.analyze_context_width(tokens, len(context['text'].split()))
                coherence_score = analyzer.analyze_semantic_coherence(tokens, context['text'])
