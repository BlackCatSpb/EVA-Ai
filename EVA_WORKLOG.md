...
1. **Перед запуском** - самостоятельно очищаю логи (`*.log` в корне и в `logs/`)
2. **После каждого исправления** - сверяюсь с планом
3. **Ошибки связанные напрямую с текущим исправлением** - исправляю сразу, в рамках текущей задачи
4. **Ошибки НЕ связанные напрямую** - вношу в соответствующий раздел плана, продолжаю работу по плану
5. **После каждого этапа** - коммит и пуш в git
